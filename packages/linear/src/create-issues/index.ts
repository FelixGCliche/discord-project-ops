...
import { resolveLinearLabels } from './resolve-labels'
import { resolveLinearTeam, LinearTeamNotFoundError } from './resolve-team'
...
export async function createLinearIssue(
  ...
  const { issue, knownIssueIds = {} } = params
  ...
  const labelIds = await resolveLinearLabels(client, team.id, issue.labels)
